...
let customScale = 1;
let targetFps = 60;
let bgmfile = './assets/audio/Theme_298.ogg';
let bgmvolume = 0;
let bgm;
...
const AUDIO_DETAIL = [
    ...
    },
    {
        ...
        dialog: {
            ...
            English: [
                ...
                "All my fears... they're all still here."
            ],
            Chinese: [
                "虽然那些烦心事——",
                "对未来的迷茫——",
    ...
    },
    {
        ...
        dialog: {
            ...
            English: [
                "But...",
                "When I see a sky full of stars like this...",
                "...it makes everything else feel so small, so insignificant."
            ],
            Chinese: [
                "但是啊……。",
                "看到这样的星空之后呢……",
    ...
    },
    {
        ...
        dialog: {
            ...
            English: [
                "So...",
                "I'm going to find my happiness, too."
            ],
            Chinese: [
                "所以说……。",
                "我也……一定会幸福的吧。"
...
const HITBOX = {
	headpat: { xMin: 1000, xMax: 1750, yMin: 0, yMax: 400 },
	voiceline: { xMin: 1100, xMax: 2000, yMin: 1000, yMax: 1700 }
};
